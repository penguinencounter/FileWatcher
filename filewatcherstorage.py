...
def pickle_file(wf: WatchedFile):
    print(f'pickle_file: writing to reload_files/{wf.folder_name}.dat')
    with open(f'reload_files/{wf.folder_name}.dat', 'wb') as f:
        pickle.dump(wf, f)
